...
const MyUrls = () => {
    ...
    if (!render) {
        // Show loading state or return null while checking authentication/fetching data
        return null;
    }
    ...
    if (urls?.length < 1) {
        return <>
            <div className="flex flex-col text-center w-full mb-6">
                <h1 className="sm:text-3xl text-2xl font-bold title-font text-gray-900">My urls</h1>
            </div>
    ...
    return (
        <>
            <ToastContainer />
            <section className="text-gray-600 body-font flex flex-col justify-between px-4 sm:px-6 md:px-8 overflow-x-hidden">
                <div className="">
                    <div className="flex flex-col text-center w-full mb-6">
                        <h1 className="sm:text-3xl text-2xl font-bold title-font text-gray-900">My urls</h1>
                    </div>
                    {urls.map((url) => {
                        ...
                        return (
                            <div key={url._id} className="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end mt-4">
                                ...
                                <div className="flex flex-row gap-2 justify-start items-center shrink-0">
                                    {isEditing ? (
                ...
                {pagination && pagination.totalPages > 1 && (
                    <div className="flex flex-wrap justify-center items-center mt-6 sm:mt-8 gap-2 sm:gap-4 mb-2">
                        <button
